class Model(object):
    ...
    def add_mapping_op(self):
        """Implements the core of the model that transforms a batch of input data into semantic representaion.
    ...
    def predict_on_batch(self, sess, inputs_batch):
        ...
        predictions = sess.run(self.pred_train, feed_dict=feed)
        return predictions
    ...
    def build(self):
        ...
        self.pred_train = self.add_prediction(False)
