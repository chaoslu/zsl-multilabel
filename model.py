class Model(object):
    ...
    def cnn_enc(self,is_seman):
        """Implements the core of the model that transforms a batch of input data into encoded representaion.

        Returns:
            pred: A tensor of shape (batch_size, embedding_size)
        """
        raise NotImplementedError("Each Model must re-implement this method.")
    ...
    def add_mapping_op(self):
        """Implements the core of the model that transforms a batch of encoded data into semantic representaion.
    ...
    def build(self):
        ...
        # self.pred_train = self.add_prediction_train()
        # self.loss = self.add_loss_op(self.pred_train)  
        self.loss = self.add_loss_op(self.map,self.seman)
        self.train_op = self.add_training_op(self.loss)
        self.pred_test = self.add_prediction_test()
